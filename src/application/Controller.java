...
public class Controller implements Initializable {
    ...
    private DirectionMouse directionMouse = DirectionMouse.RIGHT;
    ...
    void moveSquareKeyPressed(KeyEvent event) {
        ...
        if (event.getCode().equals(KeyCode.I) && directionMouse != DirectionMouse.UP) {

            directionMouse = DirectionMouse.UP;
        } else if (event.getCode().equals(KeyCode.K) && directionMouse != DirectionMouse.DOWN) {
            directionMouse = DirectionMouse.DOWN;
            System.out.println(directionMouse);
        } else if (event.getCode().equals(KeyCode.J) && directionMouse != DirectionMouse.LEFT) {
            directionMouse = DirectionMouse.LEFT;
        } else if (event.getCode().equals(KeyCode.L) && directionMouse != DirectionMouse.RIGHT) {
            directionMouse = DirectionMouse.RIGHT;
        }
